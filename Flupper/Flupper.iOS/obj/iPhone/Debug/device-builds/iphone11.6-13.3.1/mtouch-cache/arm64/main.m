...
extern void *mono_aot_module_Flupper_iOS_info;
...
extern void *mono_aot_module_XamEffects_iOS_info;
extern void *mono_aot_module_XamEffects_info;
extern void *mono_aot_module_Flupper_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Prism_DryIoc_Forms_info;
extern void *mono_aot_module_DryIoc_info;
...
extern void *mono_aot_module_Azure_Storage_Blobs_info;
...
extern void *mono_aot_module_Azure_Storage_Common_info;
...
{
	mono_aot_register_module (mono_aot_module_Flupper_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_XamEffects_iOS_info);
	mono_aot_register_module (mono_aot_module_XamEffects_info);
	mono_aot_register_module (mono_aot_module_Flupper_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Prism_DryIoc_Forms_info);
	mono_aot_register_module (mono_aot_module_DryIoc_info);
	...
	mono_aot_register_module (mono_aot_module_Azure_Storage_Blobs_info);
	...
	mono_aot_register_module (mono_aot_module_Azure_Storage_Common_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Flupper.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
