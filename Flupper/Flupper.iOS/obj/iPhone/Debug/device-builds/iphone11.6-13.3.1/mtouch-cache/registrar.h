...
@class XamEffects_iOS_GestureRecognizers_TouchGestureRecognizerDelegate;
@class XamEffects_iOS_Renderers_BorderViewRenderer;
@class XamEffects_iOS_GestureRecognizers_TouchGestureRecognizer;
...
@interface XamEffects_iOS_GestureRecognizers_TouchGestureRecognizerDelegate : NSObject<UIGestureRecognizerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface XamEffects_iOS_Renderers_BorderViewRenderer : Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 {
}
	-(id) init;
@end

@interface XamEffects_iOS_GestureRecognizers_TouchGestureRecognizer : UIGestureRecognizer {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
